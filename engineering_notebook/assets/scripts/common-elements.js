document.addEventListener('DOMContentLoaded', function() {
    ...
    const pageRecorders = {
        ...
        // ch08: 128-157
        ...Object.fromEntries(Array.from({ length: 30 }, (_, i) => [i + 128, "印涵邸"])),
        // chzz: 158-163
        ...Object.fromEntries(Array.from({ length: 6 }, (_, i) => [i + 158, "印涵邸"])),
    };
